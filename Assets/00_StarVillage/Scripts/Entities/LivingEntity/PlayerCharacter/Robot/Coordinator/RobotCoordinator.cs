...
public class RobotCoordinator : MonoBehaviour
{
    ...
    [SerializeField] private bool m_isInteraction = false;

    [Header("test")]
    [SerializeField] private Vector3 m_targetPos;

    private bool m_isInitialized = false;
    public void InitClass(InputService inputService, RobotDataSO data, Transform cameraTransform, LootService lootService)
    {
    ...
    private void Update()
    {
        ...
        m_isInteraction = m_inputService.GetInteractionButton();
